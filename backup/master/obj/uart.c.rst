      ...
      000000                        499 	.ds 8
                                    ...
                                    575 ;	-----------------------------------------
      002175                        576 _InitialUART0_Timer1:
                           000007   577 	ar7 = 0x07
                           000006   578 	ar6 = 0x06
                           000005   579 	ar5 = 0x05
                           000004   580 	ar4 = 0x04
                           ...
                           000001   583 	ar1 = 0x01
                           000000   584 	ar0 = 0x00
      002175 AC 82            [24]  585 	mov	r4,dpl
      002177 AD 83            [24]  586 	mov	r5,dph
      002179 AE F0            [24]  587 	mov	r6,b
      00217B FF               [12]  588 	mov	r7,a
                                    589 ;	../lib/uart.c:26: P06_Quasi_Mode;		//Setting UART pin as Quasi mode for transmit
      00217C 53 B1 BF         [24]  590 	anl	_P0M1,#0xbf
      00217F 53 B2 BF         [24]  591 	anl	_P0M2,#0xbf
                                    592 ;	../lib/uart.c:27: P07_Quasi_Mode;		//Setting UART pin as Quasi mode for transmit
      002182 53 B1 7F         [24]  593 	anl	_P0M1,#0x7f
      002185 53 B2 7F         [24]  594 	anl	_P0M2,#0x7f
                                    595 ;	../lib/uart.c:29: SCON = 0x50;     	//UART0 Mode1,REN=1,TI=1
      002188 75 98 50         [24]  596 	mov	_SCON,#0x50
                                    597 ;	../lib/uart.c:30: TMOD |= 0x20;    	//Timer1 Mode1
      00218B 43 89 20         [24]  598 	orl	_TMOD,#0x20
                                    599 ;	../lib/uart.c:32: set_SMOD;        	//UART0 Double Rate Enable
      00218E 43 87 80         [24]  600 	orl	_PCON,#0x80
                                    601 ;	../lib/uart.c:33: set_T1M;
      002191 43 8E 10         [24]  602 	orl	_CKCON,#0x10
                                    603 ;	../lib/uart.c:34: clr_BRCK;        	//Serial port 0 baud rate clock source = Timer1
      002194 53 C4 DF         [24]  604 	anl	_T3CON,#0xdf
                                    605 ;	../lib/uart.c:40: TH1 = 256 - (1037500/u32Baudrate);         		     /*16.6 MHz */
      002197 8C 19            [24]  606 	mov	__divulong_PARM_2,r4
      002199 8D 1A            [24]  607 	mov	(__divulong_PARM_2 + 1),r5
      00219B 8E 1B            [24]  608 	mov	(__divulong_PARM_2 + 2),r6
      00219D 8F 1C            [24]  609 	mov	(__divulong_PARM_2 + 3),r7
      00219F 90 D4 BC         [24]  610 	mov	dptr,#0xd4bc
      0021A2 75 F0 0F         [24]  611 	mov	b,#0x0f
      0021A5 E4               [12]  612 	clr	a
      0021A6 12 27 51         [24]  613 	lcall	__divulong
      0021A9 AC 82            [24]  614 	mov	r4,dpl
      0021AB C3               [12]  615 	clr	c
      0021AC E4               [12]  616 	clr	a
      0021AD 9C               [12]  617 	subb	a,r4
      0021AE F5 8D            [12]  618 	mov	_TH1,a
                                    619 ;	../lib/uart.c:42: set_TR1;
                                    620 ;	assignBit
      0021B0 D2 8E            [12]  621 	setb	_TR1
                                    622 ;	../lib/uart.c:43: set_TI;						//For printf function must setting TI = 1
                                    623 ;	assignBit
      0021B2 D2 99            [12]  624 	setb	_TI
                                    625 ;	../lib/uart.c:44: }
      0021B4 22               [24]  626 	ret
                                    627 ;------------------------------------------------------------
                                    ...
                                    635 ;	-----------------------------------------
      0021B5                        636 _InitialUART0_Timer3:
      0021B5 AC 82            [24]  637 	mov	r4,dpl
      0021B7 AD 83            [24]  638 	mov	r5,dph
      0021B9 AE F0            [24]  639 	mov	r6,b
      0021BB FF               [12]  640 	mov	r7,a
                                    641 ;	../lib/uart.c:48: P06_Quasi_Mode;		//Setting UART pin as Quasi mode for transmit
      0021BC 53 B1 BF         [24]  642 	anl	_P0M1,#0xbf
      0021BF 53 B2 BF         [24]  643 	anl	_P0M2,#0xbf
                                    644 ;	../lib/uart.c:49: P07_Quasi_Mode;		//Setting UART pin as Quasi mode for transmit	
      0021C2 53 B1 7F         [24]  645 	anl	_P0M1,#0x7f
      0021C5 53 B2 7F         [24]  646 	anl	_P0M2,#0x7f
                                    647 ;	../lib/uart.c:51: SCON = 0x50;     //UART0 Mode1,REN=1,TI=1
      0021C8 75 98 50         [24]  648 	mov	_SCON,#0x50
                                    649 ;	../lib/uart.c:52: set_SMOD;        //UART0 Double Rate Enable
      0021CB 43 87 80         [24]  650 	orl	_PCON,#0x80
                                    651 ;	../lib/uart.c:53: T3CON &= 0xF8;   //T3PS2=0,T3PS1=0,T3PS0=0(Prescale=1)
      0021CE 53 C4 F8         [24]  652 	anl	_T3CON,#0xf8
                                    653 ;	../lib/uart.c:54: set_BRCK;        //UART0 baud rate clock source = Timer3
      0021D1 43 C4 20         [24]  654 	orl	_T3CON,#0x20
                                    655 ;	../lib/uart.c:61: RH3    = HIBYTE(65536 - (1037500/u32Baudrate)); 			/*16.6 MHz */
      0021D4 8C 19            [24]  656 	mov	__divulong_PARM_2,r4
      0021D6 8D 1A            [24]  657 	mov	(__divulong_PARM_2 + 1),r5
      0021D8 8E 1B            [24]  658 	mov	(__divulong_PARM_2 + 2),r6
      0021DA 8F 1C            [24]  659 	mov	(__divulong_PARM_2 + 3),r7
      0021DC 90 D4 BC         [24]  660 	mov	dptr,#0xd4bc
      0021DF 75 F0 0F         [24]  661 	mov	b,#0x0f
      0021E2 E4               [12]  662 	clr	a
      0021E3 12 27 51         [24]  663 	lcall	__divulong
      0021E6 AC 82            [24]  664 	mov	r4,dpl
      0021E8 AD 83            [24]  665 	mov	r5,dph
      0021EA AE F0            [24]  666 	mov	r6,b
      0021EC FF               [12]  667 	mov	r7,a
      0021ED E4               [12]  668 	clr	a
      0021EE C3               [12]  669 	clr	c
      0021EF 9C               [12]  670 	subb	a,r4
      0021F0 E4               [12]  671 	clr	a
      0021F1 9D               [12]  672 	subb	a,r5
      0021F2 F9               [12]  673 	mov	r1,a
      0021F3 74 01            [12]  674 	mov	a,#0x01
      0021F5 9E               [12]  675 	subb	a,r6
      0021F6 E4               [12]  676 	clr	a
      0021F7 9F               [12]  677 	subb	a,r7
      0021F8 89 C6            [24]  678 	mov	_RH3,r1
                                    679 ;	../lib/uart.c:62: RL3    = LOBYTE(65536 - (1037500/u32Baudrate)); 			/*16.6 MHz */
      0021FA C3               [12]  680 	clr	c
      0021FB E4               [12]  681 	clr	a
      0021FC 9C               [12]  682 	subb	a,r4
      0021FD FC               [12]  683 	mov	r4,a
      0021FE 8C C5            [24]  684 	mov	_RL3,r4
                                    685 ;	../lib/uart.c:64: set_TR3;         //Trigger Timer3
      002200 43 C4 08         [24]  686 	orl	_T3CON,#0x08
                                    687 ;	../lib/uart.c:65: set_TI;					 //For printf function must setting TI = 1
                                    688 ;	assignBit
      002203 D2 99            [12]  689 	setb	_TI
                                    690 ;	../lib/uart.c:66: }
      002205 22               [24]  691 	ret
                                    692 ;------------------------------------------------------------
                                    ...
                                    700 ;	-----------------------------------------
      002206                        701 _Receive_Data_From_UART0:
                                    702 ;	../lib/uart.c:72: while (!RI);
      002206                        703 00101$:
      002206 30 98 FD         [24]  704 	jnb	_RI,00101$
                                    705 ;	../lib/uart.c:73: c = SBUF;
      002209 85 99 82         [24]  706 	mov	dpl,_SBUF
                                    707 ;	../lib/uart.c:74: RI = 0;
                                    708 ;	assignBit
      00220C C2 98            [12]  709 	clr	_RI
                                    710 ;	../lib/uart.c:75: return (c);
                                    711 ;	../lib/uart.c:76: }
      00220E 22               [24]  712 	ret
                                    713 ;------------------------------------------------------------
                                    ...
                                    721 ;	-----------------------------------------
      00220F                        722 _Receive_Data_From_UART0_nb:
      00220F AD 82            [24]  723 	mov	r5,dpl
      002211 AE 83            [24]  724 	mov	r6,dph
      002213 AF F0            [24]  725 	mov	r7,b
                                    726 ;	../lib/uart.c:80: if (RI) {
      002215 30 98 11         [24]  727 	jnb	_RI,00102$
                                    728 ;	../lib/uart.c:81: *apu8Tmp = SBUF;
      002218 8D 82            [24]  729 	mov	dpl,r5
      00221A 8E 83            [24]  730 	mov	dph,r6
      00221C 8F F0            [24]  731 	mov	b,r7
      00221E E5 99            [12]  732 	mov	a,_SBUF
      002220 12 27 F9         [24]  733 	lcall	__gptrput
                                    734 ;	../lib/uart.c:82: RI = 0;
                                    735 ;	assignBit
      002223 C2 98            [12]  736 	clr	_RI
                                    737 ;	../lib/uart.c:83: return 1;
      002225 75 82 01         [24]  738 	mov	dpl,#0x01
      002228 22               [24]  739 	ret
      002229                        740 00102$:
                                    741 ;	../lib/uart.c:85: return 0;
      002229 75 82 00         [24]  742 	mov	dpl,#0x00
                                    743 ;	../lib/uart.c:86: }
      00222C 22               [24]  744 	ret
                                    745 ;------------------------------------------------------------
                                    ...
                                    753 ;	-----------------------------------------
      00222D                        754 _Send_Data_To_UART0:
      00222D AF 82            [24]  755 	mov	r7,dpl
                                    756 ;	../lib/uart.c:90: TI = 0;
                                    757 ;	assignBit
      00222F C2 99            [12]  758 	clr	_TI
                                    759 ;	../lib/uart.c:91: SBUF = c;
      002231 8F 99            [24]  760 	mov	_SBUF,r7
                                    761 ;	../lib/uart.c:92: while(TI==0);
      002233                        762 00101$:
      002233 30 99 FD         [24]  763 	jnb	_TI,00101$
                                    764 ;	../lib/uart.c:93: }
      002236 22               [24]  765 	ret
                                    766 ;------------------------------------------------------------
                                    ...
                                    774 ;	-----------------------------------------
      002237                        775 _InitialUART1_Timer3:
      002237 AC 82            [24]  776 	mov	r4,dpl
      002239 AD 83            [24]  777 	mov	r5,dph
      00223B AE F0            [24]  778 	mov	r6,b
      00223D FF               [12]  779 	mov	r7,a
                                    780 ;	../lib/uart.c:108: P02_Quasi_Mode;		//Setting UART pin as Quasi mode for transmit
      00223E 53 B1 FB         [24]  781 	anl	_P0M1,#0xfb
      002241 53 B2 FB         [24]  782 	anl	_P0M2,#0xfb
                                    783 ;	../lib/uart.c:109: P16_Quasi_Mode;		//Setting UART pin as Quasi mode for transmit
      002244 53 B3 BF         [24]  784 	anl	_P1M1,#0xbf
      002247 53 B4 BF         [24]  785 	anl	_P1M2,#0xbf
                                    786 ;	../lib/uart.c:112: SCON_1 = 0x58;   	//UART1 Mode1,REN_1=1,TI_1=1 TB8=1
      00224A 75 F8 58         [24]  787 	mov	_SCON_1,#0x58
                                    788 ;	../lib/uart.c:113: T3CON = 0x08;   	//T3PS2=0,T3PS1=0,T3PS0=0(Prescale=1), UART1 in MODE 1
      00224D 75 C4 08         [24]  789 	mov	_T3CON,#0x08
                                    790 ;	../lib/uart.c:114: clr_BRCK;
      002250 53 C4 DF         [24]  791 	anl	_T3CON,#0xdf
                                    792 ;	../lib/uart.c:121: RH3    = HIBYTE(65536 - (1037500/u32Baudrate));  			/*16.6 MHz */
      002253 8C 19            [24]  793 	mov	__divulong_PARM_2,r4
      002255 8D 1A            [24]  794 	mov	(__divulong_PARM_2 + 1),r5
      002257 8E 1B            [24]  795 	mov	(__divulong_PARM_2 + 2),r6
      002259 8F 1C            [24]  796 	mov	(__divulong_PARM_2 + 3),r7
      00225B 90 D4 BC         [24]  797 	mov	dptr,#0xd4bc
      00225E 75 F0 0F         [24]  798 	mov	b,#0x0f
      002261 E4               [12]  799 	clr	a
      002262 12 27 51         [24]  800 	lcall	__divulong
      002265 AC 82            [24]  801 	mov	r4,dpl
      002267 AD 83            [24]  802 	mov	r5,dph
      002269 AE F0            [24]  803 	mov	r6,b
      00226B FF               [12]  804 	mov	r7,a
      00226C E4               [12]  805 	clr	a
      00226D C3               [12]  806 	clr	c
      00226E 9C               [12]  807 	subb	a,r4
      00226F E4               [12]  808 	clr	a
      002270 9D               [12]  809 	subb	a,r5
      002271 F9               [12]  810 	mov	r1,a
      002272 74 01            [12]  811 	mov	a,#0x01
      002274 9E               [12]  812 	subb	a,r6
      002275 E4               [12]  813 	clr	a
      002276 9F               [12]  814 	subb	a,r7
      002277 89 C6            [24]  815 	mov	_RH3,r1
                                    816 ;	../lib/uart.c:122: RL3    = LOBYTE(65536 - (1037500/u32Baudrate));				/*16.6 MHz */
      002279 C3               [12]  817 	clr	c
      00227A E4               [12]  818 	clr	a
      00227B 9C               [12]  819 	subb	a,r4
      00227C FC               [12]  820 	mov	r4,a
      00227D 8C C5            [24]  821 	mov	_RL3,r4
                                    822 ;	../lib/uart.c:124: set_TR3;         //Trigger Timer3
      00227F 43 C4 08         [24]  823 	orl	_T3CON,#0x08
                                    824 ;	../lib/uart.c:125: }
      002282 22               [24]  825 	ret
                                    826 ;------------------------------------------------------------
                                    ...
                                    834 ;	-----------------------------------------
      002283                        835 _Receive_Data_From_UART1:
                                    836 ;	../lib/uart.c:131: while (!RI_1);
      002283                        837 00101$:
      002283 30 F8 FD         [24]  838 	jnb	_RI_1,00101$
                                    839 ;	../lib/uart.c:132: c = SBUF_1;
      002286 85 9A 82         [24]  840 	mov	dpl,_SBUF_1
                                    841 ;	../lib/uart.c:133: RI_1 = 0;
                                    842 ;	assignBit
      002289 C2 F8            [12]  843 	clr	_RI_1
                                    844 ;	../lib/uart.c:134: return (c);
                                    845 ;	../lib/uart.c:135: }
      00228B 22               [24]  846 	ret
                                    847 ;------------------------------------------------------------
                                    ...
                                    855 ;	-----------------------------------------
      00228C                        856 _Receive_Data_From_UART1_nb:
      00228C AD 82            [24]  857 	mov	r5,dpl
      00228E AE 83            [24]  858 	mov	r6,dph
      002290 AF F0            [24]  859 	mov	r7,b
                                    860 ;	../lib/uart.c:139: if (RI_1) {
      002292 30 F8 11         [24]  861 	jnb	_RI_1,00102$
                                    862 ;	../lib/uart.c:140: *apu8Tmp = SBUF_1;
      002295 8D 82            [24]  863 	mov	dpl,r5
      002297 8E 83            [24]  864 	mov	dph,r6
      002299 8F F0            [24]  865 	mov	b,r7
      00229B E5 9A            [12]  866 	mov	a,_SBUF_1
      00229D 12 27 F9         [24]  867 	lcall	__gptrput
                                    868 ;	../lib/uart.c:141: RI_1 = 0;
                                    869 ;	assignBit
      0022A0 C2 F8            [12]  870 	clr	_RI_1
                                    871 ;	../lib/uart.c:142: return 1;
      0022A2 75 82 01         [24]  872 	mov	dpl,#0x01
      0022A5 22               [24]  873 	ret
      0022A6                        874 00102$:
                                    875 ;	../lib/uart.c:144: return 0;
      0022A6 75 82 00         [24]  876 	mov	dpl,#0x00
                                    877 ;	../lib/uart.c:145: }
      0022A9 22               [24]  878 	ret
                                    879 ;------------------------------------------------------------
                                    ...
                                    887 ;	-----------------------------------------
      0022AA                        888 _Send_Data_To_UART1:
      0022AA AF 82            [24]  889 	mov	r7,dpl
                                    890 ;	../lib/uart.c:149: TI_1 = 0;
                                    891 ;	assignBit
      0022AC C2 F9            [12]  892 	clr	_TI_1
                                    893 ;	../lib/uart.c:150: SBUF_1 = c;
      0022AE 8F 9A            [24]  894 	mov	_SBUF_1,r7
                                    895 ;	../lib/uart.c:151: while(TI_1==0);
      0022B0                        896 00101$:
      0022B0 30 F9 FD         [24]  897 	jnb	_TI_1,00101$
                                    898 ;	../lib/uart.c:152: }
      0022B3 22               [24]  899 	ret
                                    900 ;------------------------------------------------------------
                                    ...
                                    906 ;	-----------------------------------------
      0022B4                        907 _uart_setup:
                                    908 ;	../lib/uart.c:159: InitialUART0_Timer1(57600);
      0022B4 90 E1 00         [24]  909 	mov	dptr,#0xe100
      0022B7 E4               [12]  910 	clr	a
      0022B8 F5 F0            [12]  911 	mov	b,a
      0022BA 12 21 75         [24]  912 	lcall	_InitialUART0_Timer1
                                    913 ;	../lib/uart.c:160: InitialUART1_Timer3(115200);
      0022BD 90 C2 00         [24]  914 	mov	dptr,#0xc200
      0022C0 75 F0 01         [24]  915 	mov	b,#0x01
      0022C3 E4               [12]  916 	clr	a
      0022C4 12 22 37         [24]  917 	lcall	_InitialUART1_Timer3
                                    918 ;	../lib/uart.c:161: clr_TI;
                                    919 ;	assignBit
      0022C7 C2 99            [12]  920 	clr	_TI
                                    921 ;	../lib/uart.c:162: clr_TI_1;
                                    922 ;	assignBit
      0022C9 C2 F9            [12]  923 	clr	_TI_1
                                    924 ;	../lib/uart.c:163: set_ES;
                                    925 ;	assignBit
      0022CB D2 AC            [12]  926 	setb	_ES
                                    927 ;	../lib/uart.c:164: set_EA;
                                    928 ;	assignBit
      0022CD D2 AF            [12]  929 	setb	_EA
                                    930 ;	../lib/uart.c:165: }
      0022CF 22               [24]  931 	ret
                                    932 	.area CSEG    (CODE)
                                    933 	.area CONST   (CODE)
