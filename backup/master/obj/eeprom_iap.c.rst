      ...
      001882                        585 _iap_cmd:
                           ...
                           000001   592 	ar1 = 0x01
                           000000   593 	ar0 = 0x00
      001882 AF 82            [24]  594 	mov	r7,dpl
                                    595 ;	../lib/eeprom_iap.c:11: set_IAPEN; // Enable IAPEN
                                    596 ;	assignBit
      001884 A2 AF            [12]  597 	mov	c,_EA
      001886 92 00            [24]  598 	mov	_BIT_TMP,c
                                    599 ;	assignBit
      001888 C2 AF            [12]  600 	clr	_EA
      00188A 75 C7 AA         [24]  601 	mov	_TA,#0xaa
      00188D 75 C7 55         [24]  602 	mov	_TA,#0x55
      001890 43 9F 01         [24]  603 	orl	_CHPCON,#0x01
                                    604 ;	assignBit
      001893 A2 00            [12]  605 	mov	c,_BIT_TMP
      001895 92 AF            [24]  606 	mov	_EA,c
                                    607 ;	../lib/eeprom_iap.c:13: if (au8Flag) {
      001897 E5 1C            [12]  608 	mov	a,_iap_cmd_PARM_5
      001899 60 13            [24]  609 	jz	00102$
                                    610 ;	../lib/eeprom_iap.c:14: set_APUEN;							//enable APROM update
                                    611 ;	assignBit
      00189B A2 AF            [12]  612 	mov	c,_EA
      00189D 92 00            [24]  613 	mov	_BIT_TMP,c
                                    614 ;	assignBit
      00189F C2 AF            [12]  615 	clr	_EA
      0018A1 75 C7 AA         [24]  616 	mov	_TA,#0xaa
      0018A4 75 C7 55         [24]  617 	mov	_TA,#0x55
      0018A7 43 A5 01         [24]  618 	orl	_IAPUEN,#0x01
                                    619 ;	assignBit
      0018AA A2 00            [12]  620 	mov	c,_BIT_TMP
      0018AC 92 AF            [24]  621 	mov	_EA,c
      0018AE                        622 00102$:
                                    623 ;	../lib/eeprom_iap.c:17: IAPAL = au8IAPAL;
      0018AE 85 1A A6         [24]  624 	mov	_IAPAL,_iap_cmd_PARM_3
                                    625 ;	../lib/eeprom_iap.c:18: IAPAH = au8IAPAH;
      0018B1 85 19 A7         [24]  626 	mov	_IAPAH,_iap_cmd_PARM_2
                                    627 ;	../lib/eeprom_iap.c:19: IAPFD = au8IAPFD;
      0018B4 85 1B AE         [24]  628 	mov	_IAPFD,_iap_cmd_PARM_4
                                    629 ;	../lib/eeprom_iap.c:20: IAPCN = au8IAPCN;
      0018B7 8F AF            [24]  630 	mov	_IAPCN,r7
                                    631 ;	../lib/eeprom_iap.c:22: set_IAPGO; // Trig set IAPGO
                                    632 ;	assignBit
      0018B9 A2 AF            [12]  633 	mov	c,_EA
      0018BB 92 00            [24]  634 	mov	_BIT_TMP,c
                                    635 ;	assignBit
      0018BD C2 AF            [12]  636 	clr	_EA
      0018BF 75 C7 AA         [24]  637 	mov	_TA,#0xaa
      0018C2 75 C7 55         [24]  638 	mov	_TA,#0x55
      0018C5 43 A4 01         [24]  639 	orl	_IAPTRG,#0x01
                                    640 ;	assignBit
      0018C8 A2 00            [12]  641 	mov	c,_BIT_TMP
      0018CA 92 AF            [24]  642 	mov	_EA,c
                                    643 ;	../lib/eeprom_iap.c:24: if (au8Flag) {
      0018CC E5 1C            [12]  644 	mov	a,_iap_cmd_PARM_5
      0018CE 60 26            [24]  645 	jz	00105$
                                    646 ;	../lib/eeprom_iap.c:25: clr_APUEN;
                                    647 ;	assignBit
      0018D0 A2 AF            [12]  648 	mov	c,_EA
      0018D2 92 00            [24]  649 	mov	_BIT_TMP,c
                                    650 ;	assignBit
      0018D4 C2 AF            [12]  651 	clr	_EA
      0018D6 75 C7 AA         [24]  652 	mov	_TA,#0xaa
      0018D9 75 C7 55         [24]  653 	mov	_TA,#0x55
      0018DC 53 A5 FE         [24]  654 	anl	_IAPUEN,#0xfe
                                    655 ;	assignBit
      0018DF A2 00            [12]  656 	mov	c,_BIT_TMP
      0018E1 92 AF            [24]  657 	mov	_EA,c
                                    658 ;	../lib/eeprom_iap.c:26: clr_IAPEN;
                                    659 ;	assignBit
      0018E3 A2 AF            [12]  660 	mov	c,_EA
      0018E5 92 00            [24]  661 	mov	_BIT_TMP,c
                                    662 ;	assignBit
      0018E7 C2 AF            [12]  663 	clr	_EA
      0018E9 75 C7 AA         [24]  664 	mov	_TA,#0xaa
      0018EC 75 C7 55         [24]  665 	mov	_TA,#0x55
      0018EF 53 9F FE         [24]  666 	anl	_CHPCON,#0xfe
                                    667 ;	assignBit
      0018F2 A2 00            [12]  668 	mov	c,_BIT_TMP
      0018F4 92 AF            [24]  669 	mov	_EA,c
      0018F6                        670 00105$:
                                    671 ;	../lib/eeprom_iap.c:28: }
      0018F6 22               [24]  672 	ret
                                    673 ;------------------------------------------------------------
                                    ...
                                    681 ;	-----------------------------------------
      0018F7                        682 _Erase_APROM_Page:
      0018F7 AE 82            [24]  683 	mov	r6,dpl
      0018F9 AF 83            [24]  684 	mov	r7,dph
                                    685 ;	../lib/eeprom_iap.c:33: iap_cmd(0x22, (u16EPAddr>>8)&0xff, u16EPAddr&0xff, 0xFF, 1);
      0018FB 8F 19            [24]  686 	mov	_iap_cmd_PARM_2,r7
      0018FD 8E 1A            [24]  687 	mov	_iap_cmd_PARM_3,r6
      0018FF 75 1B FF         [24]  688 	mov	_iap_cmd_PARM_4,#0xff
      001902 75 1C 01         [24]  689 	mov	_iap_cmd_PARM_5,#0x01
      001905 75 82 22         [24]  690 	mov	dpl,#0x22
                                    691 ;	../lib/eeprom_iap.c:34: }
      001908 02 18 82         [24]  692 	ljmp	_iap_cmd
                                    693 ;------------------------------------------------------------
                                    ...
                                    702 ;	-----------------------------------------
      00190B                        703 _Write_APROM_BYTE:
      00190B AE 82            [24]  704 	mov	r6,dpl
      00190D AF 83            [24]  705 	mov	r7,dph
                                    706 ;	../lib/eeprom_iap.c:39: iap_cmd(0x21, (u16EPAddr>>8)&0xff, u16EPAddr&0xff, u8EPData, 1);
      00190F 8F 19            [24]  707 	mov	_iap_cmd_PARM_2,r7
      001911 8E 1A            [24]  708 	mov	_iap_cmd_PARM_3,r6
      001913 85 10 1B         [24]  709 	mov	_iap_cmd_PARM_4,_Write_APROM_BYTE_PARM_2
      001916 75 1C 01         [24]  710 	mov	_iap_cmd_PARM_5,#0x01
      001919 75 82 21         [24]  711 	mov	dpl,#0x21
                                    712 ;	../lib/eeprom_iap.c:40: }
      00191C 02 18 82         [24]  713 	ljmp	_iap_cmd
                                    714 ;------------------------------------------------------------
                                    ...
                                    723 ;	-----------------------------------------
      00191F                        724 _read_bandgap_value:
                                    725 ;	../lib/eeprom_iap.c:45: iap_cmd(0x04,0x00,0x0c,0,0);
      00191F 75 19 00         [24]  726 	mov	_iap_cmd_PARM_2,#0x00
      001922 75 1A 0C         [24]  727 	mov	_iap_cmd_PARM_3,#0x0c
      001925 75 1B 00         [24]  728 	mov	_iap_cmd_PARM_4,#0x00
      001928 75 1C 00         [24]  729 	mov	_iap_cmd_PARM_5,#0x00
      00192B 75 82 04         [24]  730 	mov	dpl,#0x04
      00192E 12 18 82         [24]  731 	lcall	_iap_cmd
                                    732 ;	../lib/eeprom_iap.c:46: BandgapHigh = IAPFD;
      001931 AF AE            [24]  733 	mov	r7,_IAPFD
                                    734 ;	../lib/eeprom_iap.c:47: iap_cmd(0x04,0x00,0x0d,0,0);
      001933 75 19 00         [24]  735 	mov	_iap_cmd_PARM_2,#0x00
      001936 75 1A 0D         [24]  736 	mov	_iap_cmd_PARM_3,#0x0d
      001939 75 1B 00         [24]  737 	mov	_iap_cmd_PARM_4,#0x00
      00193C 75 1C 00         [24]  738 	mov	_iap_cmd_PARM_5,#0x00
      00193F 75 82 04         [24]  739 	mov	dpl,#0x04
      001942 C0 07            [24]  740 	push	ar7
      001944 12 18 82         [24]  741 	lcall	_iap_cmd
      001947 D0 07            [24]  742 	pop	ar7
                                    743 ;	../lib/eeprom_iap.c:48: BandgapLow = IAPFD;
      001949 E5 AE            [12]  744 	mov	a,_IAPFD
                                    745 ;	../lib/eeprom_iap.c:49: BandgapLow = BandgapLow&0x0F;
      00194B 54 0F            [12]  746 	anl	a,#0x0f
      00194D FE               [12]  747 	mov	r6,a
                                    748 ;	../lib/eeprom_iap.c:50: clr_IAPEN; // Disable IAPEN
                                    749 ;	assignBit
      00194E A2 AF            [12]  750 	mov	c,_EA
      001950 92 00            [24]  751 	mov	_BIT_TMP,c
                                    752 ;	assignBit
      001952 C2 AF            [12]  753 	clr	_EA
      001954 75 C7 AA         [24]  754 	mov	_TA,#0xaa
      001957 75 C7 55         [24]  755 	mov	_TA,#0x55
      00195A 53 9F FE         [24]  756 	anl	_CHPCON,#0xfe
                                    757 ;	assignBit
      00195D A2 00            [12]  758 	mov	c,_BIT_TMP
      00195F 92 AF            [24]  759 	mov	_EA,c
                                    760 ;	../lib/eeprom_iap.c:51: return (BandgapHigh<<4)+BandgapLow;
      001961 E4               [12]  761 	clr	a
      001962 C4               [12]  762 	swap	a
      001963 54 F0            [12]  763 	anl	a,#0xf0
      001965 CF               [12]  764 	xch	a,r7
      001966 C4               [12]  765 	swap	a
      001967 CF               [12]  766 	xch	a,r7
      001968 6F               [12]  767 	xrl	a,r7
      001969 CF               [12]  768 	xch	a,r7
      00196A 54 F0            [12]  769 	anl	a,#0xf0
      00196C CF               [12]  770 	xch	a,r7
      00196D 6F               [12]  771 	xrl	a,r7
      00196E FD               [12]  772 	mov	r5,a
      00196F 7C 00            [12]  773 	mov	r4,#0x00
      001971 EE               [12]  774 	mov	a,r6
      001972 2F               [12]  775 	add	a,r7
      001973 F5 82            [12]  776 	mov	dpl,a
      001975 EC               [12]  777 	mov	a,r4
      001976 3D               [12]  778 	addc	a,r5
      001977 F5 83            [12]  779 	mov	dph,a
                                    780 ;	../lib/eeprom_iap.c:52: }
      001979 22               [24]  781 	ret
                                    782 ;------------------------------------------------------------
                                    ...
                                    791 ;	-----------------------------------------
      00197A                        792 _read_uid:
      00197A 85 82 1A         [24]  793 	mov	_iap_cmd_PARM_3,dpl
                                    794 ;	../lib/eeprom_iap.c:57: iap_cmd(0x04,0x00,au8Idx,0,0);
      00197D 75 19 00         [24]  795 	mov	_iap_cmd_PARM_2,#0x00
      001980 75 1B 00         [24]  796 	mov	_iap_cmd_PARM_4,#0x00
      001983 75 1C 00         [24]  797 	mov	_iap_cmd_PARM_5,#0x00
      001986 75 82 04         [24]  798 	mov	dpl,#0x04
      001989 12 18 82         [24]  799 	lcall	_iap_cmd
                                    800 ;	../lib/eeprom_iap.c:58: u8Uid = IAPFD;
      00198C 85 AE 82         [24]  801 	mov	dpl,_IAPFD
                                    802 ;	../lib/eeprom_iap.c:59: clr_IAPEN; // Disable IAPEN
                                    803 ;	assignBit
      00198F A2 AF            [12]  804 	mov	c,_EA
      001991 92 00            [24]  805 	mov	_BIT_TMP,c
                                    806 ;	assignBit
      001993 C2 AF            [12]  807 	clr	_EA
      001995 75 C7 AA         [24]  808 	mov	_TA,#0xaa
      001998 75 C7 55         [24]  809 	mov	_TA,#0x55
      00199B 53 9F FE         [24]  810 	anl	_CHPCON,#0xfe
                                    811 ;	assignBit
      00199E A2 00            [12]  812 	mov	c,_BIT_TMP
      0019A0 92 AF            [24]  813 	mov	_EA,c
                                    814 ;	../lib/eeprom_iap.c:60: return u8Uid;
                                    815 ;	../lib/eeprom_iap.c:61: }
      0019A2 22               [24]  816 	ret
                                    817 	.area CSEG    (CODE)
                                    818 	.area CONST   (CODE)
